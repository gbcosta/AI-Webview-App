    ...
    <div className="h-screen flex justify-center">
      <div className="h-screen bg-background-primary grid grid-cols-12 grid-rows-12 w-7xl">
        <div className="border-r-2 border-border-primary col-span-4 row-span-12">
          <ul className="flex flex-col">{tabsComponents}</ul>
        </div>
...
const View = ({
  ...
  return (
    <div className="flex flex-col pl-4 pt-1 gap-2">
...
const MenuTabItem = ({
  ...
  const selected = "bg-zinc-200 text-zinc-950";
  const notSelected = "hover:bg-border-primary";
  const isSelected = tabName == tabSelected ? selected : notSelected;
  return (
    <li
      className={`text-text-secondary px-4 py-1 ${isSelected}`}
      onClick={() => {
